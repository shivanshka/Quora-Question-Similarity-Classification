...
from Quora_App.pipeline import *

ROOT_DIR = os.getcwd()
LOG_FOLDER_NAME = "application_logs"
PIPELINE_FOLDER_NAME = "Quora_App"
...
@app.route('/artifact', defaults={'req_path': 'Quora_Artifacts'})
@app.route('/artifact/<path:req_path>')
def render_artifact_dir(req_path):
    os.makedirs("Quora_Artifacts", exist_ok=True)
...
@app.route('/logs', defaults={'req_path': 'application_logs'})
